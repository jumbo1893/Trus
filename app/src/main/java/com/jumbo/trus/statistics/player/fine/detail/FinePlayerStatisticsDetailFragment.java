...
public class FinePlayerStatisticsDetailFragment extends CustomUserFragment {

    private static final String TAG = "FinePlayerStatisticsDetailFragment";
    ...
    private FinePlayerStatisticsDetailViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(FinePlayerStatisticsDetailViewModel.class);
