...
public class TableBeerStatisticsFragment extends TableStatisticsHelperFragment {
    ...
    private TableBeerStatisticsViewModel viewModel;

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(requireActivity()).get(TableBeerStatisticsViewModel.class);
        viewModel.init();
