...
public class TableFineDetailStatisticsFragment extends TableStatisticsHelperFragment {

    private static final String TAG = "TableFineDetailStatisticsFragment";

    //widgety


    private TableFineDetailStatisticsViewModel viewModel;

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(requireActivity()).get(TableFineDetailStatisticsViewModel.class);
        viewModel.init();
