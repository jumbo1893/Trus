package com.jumbo.trus.statistics.table.beer;
...
public class TableBeerStatisticsViewModel extends MatchHelperStatisticsViewModel implements ChangeListener, IRequestListener {

    private static final String TAG = "TableBeerStatisticsViewModel";
    ...
    private void makeTextsForBeersTable(List<Match> selectedMatches, List<Player> selectedPlayers) {
        //první řádek
    ...
    private void startMakingTexts(List<Match> matchList, List<Player> playerList) {
        if (matchList != null && playerList != null) {
            makeTextsForBeersTable(filterMatches(matchList, false), playerList);
        }
    }
