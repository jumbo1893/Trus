...
public class BeerMatchStatisticsDetailFragment extends CustomUserFragment {
    ...
    private BeerMatchStatisticsDetailViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(BeerMatchStatisticsDetailViewModel.class);
