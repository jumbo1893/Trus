...
public class OrderByYellowCardsNumber implements Comparator<PkflPlayerStats> {

    private boolean desc;

    public OrderByYellowCardsNumber(boolean desc) {
        this.desc = desc;
    }
    ...
    public int compare(PkflPlayerStats o1, PkflPlayerStats o2) {
        if (desc) {
            Integer x1 = o1.getYellowCards();
            Integer x2 = o2.getYellowCards();
