...
public class OrderByGoalkeepingMinutesNumber implements Comparator<PkflPlayerStats> {

    private boolean desc;

    public OrderByGoalkeepingMinutesNumber(boolean desc) {
        this.desc = desc;
    }
    ...
    public int compare(PkflPlayerStats o1, PkflPlayerStats o2) {
        if (desc) {
            Integer x1 = o1.getGoalkeepingMinutes();
            Integer x2 = o2.getGoalkeepingMinutes();
