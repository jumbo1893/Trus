...
public class OrderByRedCardsNumber implements Comparator<PkflPlayerStats> {

    private boolean desc;

    public OrderByRedCardsNumber(boolean desc) {
        this.desc = desc;
    }
    ...
    public int compare(PkflPlayerStats o1, PkflPlayerStats o2) {
        if (desc) {
            Integer x1 = o1.getRedCards();
            Integer x2 = o2.getRedCards();
